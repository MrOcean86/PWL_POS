...
--
-- Host: localhost:3306
-- Generation Time: Jul 03, 2025 at 05:45 PM
...
(5, '2025_05_13_125814_create_m_level_table', 1),
(6, '2025_05_13_132544_create_m_user_table', 1),
(7, '2025_05_13_135440_create_m_supplier_table', 1),
(8, '2025_05_13_141338_create_m_kategori_table', 1),
(9, '2025_05_14_055039_create_m_barang_table', 1),
(10, '2025_06_22_152557_create_t_penjualan_table', 1),
(11, '2025_06_22_152810_create_t_stok_table', 1),
(12, '2025_06_22_154322_create_t_penjualan_detail_table', 1);
...
CREATE TABLE `m_barang` (
  ...
  `m_kategori_id` bigint UNSIGNED NOT NULL,
...
(1, 'ADM', 'admin', '2025-07-03 09:47:03', '2025-07-03 09:47:03'),
(2, 'MNG', 'manager', '2025-07-03 09:47:03', '2025-07-03 09:47:03'),
(3, 'STF', 'staf', '2025-07-03 09:47:03', '2025-07-03 09:47:03'),
(4, 'KSR', 'kasir\r\n', '2025-07-03 09:47:03', '2025-07-03 09:47:03');
...
(1, 1, 'adminadmin', 'admin', 'adminadmin', '2025-07-03 09:47:45', '2025-07-03 09:47:45'),
(2, 1, 'admin', 'admin2', 'admin', '2025-07-03 09:47:45', '2025-07-03 09:47:45');
...
ALTER TABLE `m_barang`
  ...
  ADD KEY `m_barang_m_kategori_id_index` (`m_kategori_id`);
...
--
ALTER TABLE `m_barang`
  ADD CONSTRAINT `m_barang_m_kategori_id_foreign` FOREIGN KEY (`m_kategori_id`) REFERENCES `m_kategori` (`kategori_id`);
